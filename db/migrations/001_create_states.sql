-- =============================================================================
-- Migration: 001_create_states.sql
-- Table:     states
-- Purpose:   Lookup table for all 50 US states.
--            Referenced as a FK by flights and tickets tables.
-- Seed:      All 50 US states (state_code + state_name).
